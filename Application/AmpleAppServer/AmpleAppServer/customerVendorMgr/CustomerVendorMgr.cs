   ...
   public class CustomerVendorMgr:System.MarshalByRefObject
    {
            ...
            int amount, string notes)
       {
         ...
         string strSql = "INSERT INTO custVendor VALUES(" + cvtype + ",'" + cvname + "','" + country + "'," + rate + ",'" + term + "','" + contact1 + "','" +
               contact2 + "','" + phone1 + "','" + phone2 + "','" + cellphone + "','" + fax + "','" + email1 + "','" + email2 + "'," + ownerName + "," + lastUpdateName +
               ",'" + lastUpdateDate.ToShortDateString() + "'," + blacklisted + "," + amount + ",'" + notes + ")";
            ...
            int amount, string notes)
       {
           string strSql = "UPDATE custVendor SET cvname='" + cvname + "',country='" + country + "',rate=" + rate + ",term='" + term + "',contact1='" + contact1 + "',contact2'" +
               ...
               ",lastUpdateDate='" + lastUpdateDate.ToShortDateString() + "',blackListed=" + blacklisted + ",amount=" + amount + ",notes='" + notes + " WHERE cvtype=" + cvname + " and cvName=" + previousName;
